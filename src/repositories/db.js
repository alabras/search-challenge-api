...
const connectDb = async (callback) => {
  ...
  assert.notStrictEqual(mongodbUrl, undefined, 'You must set environment variable of MONGO_CONNECTION.')
...
const getDb = (collectionName) => {
  ...
  assert.notStrictEqual(mongoDataBase, undefined, 'You must set environment variable of MONGO_DATABASE.')
